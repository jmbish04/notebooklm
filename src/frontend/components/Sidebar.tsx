    ...
    <div className="flex h-screen bg-gray-900 text-white">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-gray-800 p-4">
        ...
        <nav className="flex flex-col gap-4">
          ...
          <a href="/chat" className="hover:bg-gray-700 p-2 rounded">
            Honi Chat
          </a>
          <a href="/swagger" className="hover:bg-gray-700 p-2 rounded">
            Swagger API
          </a>
          <a href="/scaler" className="hover:bg-gray-700 p-2 rounded">
            Scalar API
          </a>
        </nav>
      </aside>
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden relative">
        ...
        <main className="flex-1 overflow-auto bg-gray-950 p-4">{children}</main>
      </div>
    </div>
  );
}
